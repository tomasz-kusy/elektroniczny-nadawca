...
namespace TomaszKusy\En\GetAddresLabelByGuidCompactResponse;

/**
 * Class representing GetAddresLabelByGuidCompactResponseAType
 */
class GetAddresLabelByGuidCompactResponseAType
{
